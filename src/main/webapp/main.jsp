						...
						<div class="inner">
							<section>
								...
								<div class="field half first">
										...
										<input type="text"  id="mem_name" placeholder="보내는 사람 이름" />
									</div>
									<div class="field half">
										<label for="email">Email</label>
										<input type="text"  id="mem_id" placeholder="보낼 사람 이메일"/>
									</div>
