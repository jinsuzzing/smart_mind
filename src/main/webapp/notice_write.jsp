...
<link rel="stylesheet" href="assets/css/notice_write.css">
</head>
<body>
	...
	<section class="notice">
		...
		<form action="noticeservice" method="post">
			...
			<div id="board_write">
				<div id="write_area">
					...
					<div id="content">
						<textarea name="post_content" id="ucontent"
